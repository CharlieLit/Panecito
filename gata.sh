...
if wget -q https://github.com/CharlieLit/Panecito/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[1;35m"
git clone https://github.com/CharlieLit/Panecito.git
